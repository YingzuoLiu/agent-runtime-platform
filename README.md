...
| Store conformance | Backend-parameterized contracts for ownership, fencing, checkpoint CAS, recovery, and quarantine | [`docs/store-semantic-conformance.md`](docs/store-semantic-conformance.md), [`tests/conformance`](tests/conformance) |
